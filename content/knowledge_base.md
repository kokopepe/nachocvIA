...
When I joined DHL IT Services as Domain Manager, I faced a critical service experiencing frequent outages. I implemented a structured approach:
1. Formed a dedicated task force
2. Conducted thorough root cause analysis
3. Identified and resolved a complex memory leak
4. Implemented monitoring improvements

**Result:** 30% reduction in support effort and significantly improved service stability.

## Digital Transformation
At Sysmex Europe, I led a major ServiceNow implementation:
1. Deployed Incident Management across Germany in 5 months
2. Collaborated with integrator in agile setup
3. Established new processes and trained staff
4. Achieved 98% user adoption rate

**Result:** Streamlined IT service management and improved response times by 40%.
